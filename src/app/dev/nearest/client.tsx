...
/**
 * Interactive client component for /dev/nearest. The parent server
 * component gates on NODE_ENV via notFound(), so this component (and the
 * Mapbox GL bundle it pulls in) only renders in dev.
 */
...
export default function NearestDevClient() {
