...
export default function NewIncidentForm({ initialUnitId }: { initialUnitId: string }) {
  ...
  // Prefilled from the authenticated firefighter's home unit; user can edit
  // before submitting (e.g. a callout from a covering unit).
